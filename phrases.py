...
def display_welcome():
    print(
        "Welcome to ConnectMeWith! We will pair you with another Twitter user and share social movement information!"
    )
...
def link():
    ...
    while choice == 5:
        ...
        if choice == 2:  # feminism, femicide, womanism, transwomen, incarcerated women
            print(
                "here is a great link to start the conversation", "#link",
            )
